...
# Input folders
img_dir = os.path.join(SCRIPT_DIR, "..", "data", "resplit_data", "images", "train")
lbl_dir = os.path.join(SCRIPT_DIR, "..", "data", "resplit_data", "labels", "train")

# Output folders
aug_img_dir = os.path.join(SCRIPT_DIR, "..", "data", "resplit_data", "images", "train")
aug_lbl_dir = os.path.join(SCRIPT_DIR, "..", "data", "resplit_data", "labels", "train")
